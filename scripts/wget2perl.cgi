...
get  '/' => sub( $c ) {
    $c->render(as_perl( 'Tiny', 'wget "https://example.com"' ))
} => 'index';
...
<html>
<head>
<title>wget-to-lwp - Convert wget commands to Perl</title>
...
<script type="application/ld+json">
{
  ...
  "@id": "wget2lwp",
  "@type": "WebApplication",
  "name": "Convert wget commands to Perl code",
  "url": "https://corion.net/wget2lwp.psgi",
  "applicationCategory": "Utility",
  "applicationSubCategory": "Programming",
  "about": "This converts wget commands to Perl code",
  "browserRequirements": "",
...
<body>
<h2>Paste your <code>wget</code> command here</h2>
<p><a href="curl2lwp.psgi">Switch to Curl input</a> - <a href="https://curl.se/h2c/">Headers to Curl</a></p></p>
<p><a href="fetch2lwp.psgi">Switch to fetch() input</a></p>
